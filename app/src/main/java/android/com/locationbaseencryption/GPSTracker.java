        ...
        try {
            ...
            if (!isGPSEnabled && !isNetworkEnabled) {
                ...
                if (isNetworkEnabled) {
                    ...
                    Log.e("######", " Location permission before condition ");
                    ...
                    if (ActivityCompat.checkSelfPermission((Activity) mContext, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED &&
                        ...
                        Log.e("#####", "Now we are in permission ");
                        ...
                        if (locationManager != null) {
                            ...
                            Log.e("#####", " Location values is as " + location);
                ...
                if (isGPSEnabled) {
                    if (location == null) {
                        locationManager.requestLocationUpdates(
                                ...
                                MIN_TIME_BW_UPDATES,
                                MIN_DISTANCE_CHANGE_FOR_UPDATES, this);
                        Log.e("GPS Enabled", "GPS Enabled location manager " + locationManager);
                        if (locationManager != null) {

                            location = locationManager
                                    .getLastKnownLocation(LocationManager.GPS_PROVIDER);

                            Log.e("#####", " Location status is as " + location);
